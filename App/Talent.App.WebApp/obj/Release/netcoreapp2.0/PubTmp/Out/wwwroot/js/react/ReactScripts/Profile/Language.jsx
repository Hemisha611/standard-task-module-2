...
export default class Language extends React.Component {
    ...
    loadData() {
        ...
        $.ajax({
            url: 'https://talentprofile1.azurewebsites.net/profile/profile/getLanguage',
    ...
    addLanguages() {
        ...
        var cookies = Cookies.get('talentAuthToken');
        $.ajax({
            url: 'https://talentprofile1.azurewebsites.net/profile/profile/addLanguage',
    ...
    deleteLanguages() {
        ...
        var cookies = Cookies.get('talentAuthToken');
        $.ajax({
            url: 'https://talentprofile1.azurewebsites.net/profile/profile/deleteLanguage',
    ...
    updateLanguages() {
        ...
        var cookies = Cookies.get('talentAuthToken');
        $.ajax({
            url: 'https://talentprofile1.azurewebsites.net/profile/profile/updateLanguage',
