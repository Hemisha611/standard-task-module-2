...
export default class CreateJob extends React.Component {
    ...
    loadData() {
        ...
        if (param != "" || copyJobParam != "") {
            ...
            var link = param != "" ? 'https://talentservicestalent1.azurewebsites.net/listing/listing/GetJobByToEdit?id=' + param
                : 'https://talentservicestalent1.azurewebsites.net/listing/listing/GetJobForCopy?id=' + copyJobParam;
    ...
    addUpdateJob() {
        ...
        $.ajax({
            ...
            url: 'https://talentservicestalent1.azurewebsites.net/listing/listing/createUpdateJob',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
