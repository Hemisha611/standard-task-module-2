...
export default class ResetPassword extends React.Component {
    ...
    checkToken(email, token) {
        ...
        let url = `https://talentidentity1.azurewebsites.net/authentication/authentication/verifyResetPasswordToken?o=${email}&p=${token}`;
    ...
    savePassword() {
        ...
        let resetUrl = `https://talentidentity1.azurewebsites.net/authentication/authentication/resetpassword?o=${email}&p=${token}`;
