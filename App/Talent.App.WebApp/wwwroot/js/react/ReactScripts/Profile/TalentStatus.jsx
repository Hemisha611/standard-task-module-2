                    ...
                    <React.Fragment>
                        <Form>
                            <Form.Field>
                                ...
                                <input type='radio' label='Actively looking for a job' id='jobStatus-1'
                                    name='status' value='Actively looking for a job'
                                    checked={(this.state.newstatus.status === 'Actively looking for a job') ||
                            ...
                            <Form.Field>
                                ...
                                <input type='radio' label='Not looking for a job at the moment' id='jobStatus-2'
                                    name='status' value='Not looking for a job at the moment'
                                    checked={(this.state.newstatus.status === 'Not looking for a job at the moment') ||
                                        (this.props.status.status === 'Not looking for a job at the moment')}
                                    onChange={this.handleChange}
                                />
                            ...
                            <Form.Field>
                                ...
                                <input type='radio' label='Currently employed but open to offers' id='jobStatus-3' name='status'
                                    value='Currently employed but open to offers'
                                    checked={(this.state.newstatus.status === 'Currently employed but open to offers') ||
                                       (this.props.status.status === 'Currently employed but open to offers')}
                                    onChange={this.handleChange}
                                />
                            ...
                            <Form.Field>
                                ...
                                <input type='radio' label='Will be available on later date' id='jobStatus-4'
                                    name='status' value='Will be available on later date'
                                    checked={(this.state.newstatus.status === 'Will be available on later date') ||
                            ...
                            <button type="button" className="ui teal button" onClick={this.check.bind(this)}
                            > Save </button>
                        </Form>
                    </React.Fragment>
                </div>
