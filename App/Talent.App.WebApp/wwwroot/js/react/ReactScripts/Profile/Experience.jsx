...
export default class Experience extends React.Component {
    ...
    loadData() {
        ...
        $.ajax({
            url: 'https://talentprofile1.azurewebsites.net/profile/profile/getExperience',
    ...
    addExperiences() {
        ...
        var cookies = Cookies.get('talentAuthToken');
        $.ajax({
            url: 'https://talentprofile1.azurewebsites.net/profile/profile/addExperience',
    ...
    deleteExperiences() {
        ...
        var cookies = Cookies.get('talentAuthToken');
        $.ajax({
            url: 'https://talentprofile1.azurewebsites.net/profile/profile/deleteExperience',
    ...
    updateExperiences() {
        ...
        $.ajax({
            ...
            url: 'https://talentprofile1.azurewebsites.net/profile/profile/UpdateExperience',
