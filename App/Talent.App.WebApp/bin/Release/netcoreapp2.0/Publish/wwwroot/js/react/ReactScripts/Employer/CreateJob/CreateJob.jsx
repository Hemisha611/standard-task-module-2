...
export default class CreateJob extends React.Component {
    ...
    loadData() {
        ...
        if (param != "" || copyJobParam != "") {
            var link = param != "" ? 'https://talentservicetalent1.azurewebsites.net?id=' + param
                : 'https://talentservicetalent1.azurewebsites.net?id=' + copyJobParam;
    ...
    addUpdateJob() {
        ...
        var cookies = Cookies.get('talentAuthToken');   
        $.ajax({
            url: 'https://talentservicetalent1.azurewebsites.net',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
