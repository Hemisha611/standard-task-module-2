...
export class Images extends React.Component {
    ...
    loadImages(Id) {
        ...
        $.ajax({
            ...
            url: 'https://talentserviceprofile.azurewebsites.net?id=' + Id,
            ...
            success: function (res) {
                ...
                if (res.employerProfile.length > 0) {
                    for (var i = 0; i < res.employerProfile.length; i++) {
                       // imageSrcArr.push("http://standardtaskm1.azurewebsites.net/?Id=" + res.employerProfile[i].fileName);
    ...
    fileUploadHandler(Id) {
        ...
        $.ajax({
            ...
            url: 'https://talentserviceprofile.azurewebsites.net',
